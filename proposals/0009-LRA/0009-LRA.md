   * [Long Running Actions](#long-running-actions)
      ...
      * [Proposed solution](#proposed-solution)
         * [The Model](#the-model)
         * [CDI-based approach](#cdi-based-approach)
      ...
      * [Appendix 1 Interoperability with 2PC ACID (XA) transactions](#appendix-1-interoperability-with-2pc-acid-xa-transactions)
...
[The protocol documentation](http://narayana.io//docs/specs/restat-v2-draft-8-2013-jul-29.pdf) describes the approach in detail. In this proposal we:
- summarise the main features;
- define a set of CDI annotations for use with JAX-RS resources;

 here and . It includes the following actors:
